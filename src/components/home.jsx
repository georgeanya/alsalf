    ...
    <div>
      ...
      <div id="about">
        ...
        <p className="sub_body_text">
          ...
          the community with good healthcare support. We believe a healthy
          community is a productive community and we are willing to go the extra
          mile to ensure the average Abiriba indigene living in Abiriba has
          access to immediate assitance to quality health care.
        </p>
      </div>
      <div id="aim">
        ...
        <p className="sub_body_text">
          ...
          detection of ailments, providing advise and support to prevent these
          ailments from getting out of control and also providing aftercare
          support to these people.<br/>For us to achive this we need far and near
          Abriba Indigenes to come together to provide support.
        </p>
      </div>
      {/* <div id="founders">
        <div>
